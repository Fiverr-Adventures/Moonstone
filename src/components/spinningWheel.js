...
const SpinningWheel = () => {
    ...
    const Wheel = styled.div`
        animation: spin 5s cubic-bezier(0.45,-0.37, 0, 1.00);
    ...
    return (
            <div className='spinningWheel'>
                <Header style={{ width: '100%',}} title='Achievements'>
                    <div style={{display: 'flex', whiteSpace: 'nowrap', paddingTop: '7%'}}>
                ...
                <Button style={{marginTop: '20px'}} width='208px' inner='15 tokens 💰' onClick={() => setRotate(curr => getrotateDegree(100, 1300))}>SPIN THE WHEEL</Button>
            </div>
     );
}
